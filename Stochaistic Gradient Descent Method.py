...
theta, bias, losses = stochastic_gradient_descent(X_train, y_train)
...
plt.title("Stochastic Gradient Descent: Predicted vs Actual")
plt.xlabel("Actual")
...
plt.title("Stochastic Gradient Descent: Performance Metrics")
plt.ylabel("Value")
plt.show()
